...
public class PluginConfigurationWrapper {
    private final String JAR_NAME = "CATTO.jar";
    private final String TMP_JAR_FOLDER_RELATIVE_PATH = ".CATTOPlugin" + File.separator + "jarTmp";
    private final String JAR_FILE_RELATIVE_PATH = TMP_JAR_FOLDER_RELATIVE_PATH + File.separator + JAR_NAME;
    private final String JAR_FILE_ORIGINAL_PATH = Objects.requireNonNull(PluginConfigurationWrapper.class.getClassLoader().getResource(JAR_NAME)).toString().replace(JAR_NAME, "");
    private final String CONFIGURATION_FILE_RELATIVE_PATH = ".CATTOPlugin" + File.separator + "pluginConfiguration.yaml";
    private final String CONFIGURATION_FILE_ABSOLUTE_PATH;
    private final String CONFIGURATION_FOLDER_RELATIVE_PATH =".CATTOPlugin";
