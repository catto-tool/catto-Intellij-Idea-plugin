 ...
 */
public class EnableWhatTestsPlugin extends AnAction {

    /**
     * This default constructor is used by the IntelliJ Platform framework to instantiate this class based on plugin.xml
     * declarations. Only needed in {@link EnableWhatTestsPlugin} class because a second constructor is overridden.
     *
     * @see AnAction#AnAction()
     */
    public EnableWhatTestsPlugin() {
        super();
    }
     ...
     */
    public EnableWhatTestsPlugin(@Nullable String text, @Nullable String description, @Nullable Icon icon) {
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        pluginConfigWrapper.getConfig().setEnabled(true);
        try {
